...
<body <?php body_class();?>>
  ...
  <header class="c-header u-bg-invert">
    <a href="<?php echo home_url('/');?>"
      class="o-icon-parent o-icon-parent--center o-icon-parent--gap-s c-logo-link u-block-center o-icon-parent--header-logo">
    ...
    <button type="button" class="o-box o-box--transparent o-box--menu-btn" aria-label="menu open" aria-controls="gnav"
      aria-expanded="false">
      <span class="c-menu-bars"></span>
    </button>
  </header>
  <div id="gnav" class="c-gnav u-bg-invert" aria-hidden="true" tabindex="-1">
    <div class="c-header c-header--gnav">
      <button type="button" class="o-box o-box--transparent o-box--menu-btn u-block-right" aria-label="menu open"
        aria-controls="gnav" aria-expanded="false">
        <span class="c-menu-bars"></span>
      </button>
    </div>
    <nav class="u-pb-2xl">
      <ul class="o-stack">
        <li>
          <a href="<?php echo home_url('/aboutus/');?>"
            class="c-gnav-link c-content-l u-text-center"><span class="u-font-logo">BLUE B NOSE</span>について</a>
        </li>
        <li><a
            href="<?php echo home_url('/product/');?>"
            class="c-gnav-link c-content-l u-text-center">商品一覧</a></li>
        <li><a
            href="<?php echo home_url('/news/');?>"
            class="c-gnav-link c-content-l u-text-center">お知らせ</a></li>
        <li><a
            href="<?php echo home_url('/company/');?>"
            class="c-gnav-link c-content-l u-text-center">会社情報</a></li>
        <li><a class="c-gnav-link c-content-l u-text-center"
            href="<?php echo home_url('/blog/');?>">ブログ</a>
        </li>
        <li><a
            href="<?php echo home_url('/inquiry/');?>"
            class="c-gnav-link c-content-l u-text-center">お問い合わせ</a></li>
        <li><a
            href="<?php echo home_url('/terms-sales/');?>"
            class="c-gnav-link c-content-l u-text-center">特定商取引法に基づく表記</a></li>
        <li><a
            href="<?php echo home_url('/terms/');?>"
            class="c-gnav-link c-content-l u-text-center">サイト規約</a></li>
        <li><a
            href="<?php echo home_url('/privacy-policy/');?>"
            class="c-gnav-link c-content-l u-text-center">プライバシーポリシー</a></li>
      </ul>
    </nav>
  </div>
