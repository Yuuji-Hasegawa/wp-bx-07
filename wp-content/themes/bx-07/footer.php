...
<footer class="c-footer u-bg-invert">
  <div class="o-center u-pt-2xl u-pb-2xl">
    <div class="o-sidebar">
      <div class="o-stack o-stack--m o-sidebar__footLeft">
        ...
        <ul class="o-cluster">
          <li><a class="c-ft-link c-content-m"
              href="<?php echo home_url('/terms-sales/');?>">特定商取引法に基づく表記</a>
          </li>
          <li><a class="c-ft-link c-content-m"
      ...
      <div class="o-sidebar__footRight">
        ...
        <div class="o-cluster">
          <a class="c-sns-link c-display-s"
  ...
  <p class="c-suppl-m u-font-en-con u-text-center u-pt-l u-pb-l u-border-top">
